...
class SurahAudioListScreen extends StatefulWidget {
  const SurahAudioListScreen({super.key});

  @override
  State<SurahAudioListScreen> createState() => _SurahAudioListScreenState();
}
                ...
                return GestureDetector(
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => Detailaudiosurah(surahNumber), // Navigate to audio detail
                      ),
                    );
                  },
                  child: Container(
